...
<div id="second">
       ...
       <form class="form-inline pull-right" style="margin-top: 40px;margin-right: 10px;" action="${pageContext.request.contextPath}/goodsservlet?method=getGoodsListByTypeId" method="post">

		  <div class="form-group">
		    <input type="text" class="form-control" style="width: 400px" name="name" placeholder="搜索一下好东西...">
		  </div>
